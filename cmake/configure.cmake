...
if (LITE_WITH_CSKY)
    add_definitions("-DLITE_WITH_CSKY")
endif()
...
if (LITE_WITH_CV)
    if((NOT LITE_WITH_ARM) AND (NOT LITE_WITH_CSKY))
        message(FATAL_ERROR "CV functions uses the ARM or CSKY instructions, so LITE_WITH_ARM or LITE_WITH_CSKY must be turned on")
    endif()
